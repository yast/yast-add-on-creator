...
# Settings: Define all variables needed for configuration of add-on-creator
...
##
 # Read all add-on-creator settings
...
sub Read {
    ...
    my $caption = __("Initializing add-on-creator Configuration");
...
sub Write {
    ...
    # AddOnCreator read dialog caption
    my $caption = __("Saving add-on-creator Configuration");
...
##
 # Get all add-on-creator settings from the first parameter
...
##
 # Dump the add-on-creator settings to a single map
 # (For use by autoinstallation.)
